...
SELECT '输入设备-2', 'REST', 'INPUT', 'DS-D2055NH-B', 'SN-INPUT-002',
        2, 'HDMI-1', 'HDMI-2', '1920x1080'
WHERE NOT EXISTS (SELECT 1 FROM DEVICE_INFO);

INSERT INTO DEVICE_CAPABILITY (max_resolution, channel_count, input_channel_1, input_channel_2)
SELECT '1920x1080', 2, 'HDMI-1', 'HDMI-2'
