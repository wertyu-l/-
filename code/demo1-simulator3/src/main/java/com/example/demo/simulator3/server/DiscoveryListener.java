package com.example.demo.simulator3.server;
    ...
    public void start() {
        listenerThread = new Thread(() -> {
            try (DatagramSocket socket = new DatagramSocket(discoveryPort)) {
                ...
                System.err.println("[DiscoveryListener:9997] 端口绑定失败: " + e.getMessage());
            }
        }, "discovery-listener-9997");
